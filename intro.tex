...
In general, events to date have been designed to emphasize either a more traditional pedagogical class and lecture methodology, or emphasize more project-based learning (Figure \ref{fig:hackspectrum}).
...
\begin{figure}
\begin{center}
\includegraphics[width=8cm]{NewHackSpectrum.png}
