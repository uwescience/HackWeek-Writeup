...
While some hack weeks are focused more on education than others (see Figure \ref{fig:hackspectrum}), there is often a skill-development component in the form of tutorials and informal and peer learning. This type of lateral knowledge transfer \cite{b:wilson-swc-lessons-2016} is a core attribute of a hack week, and provides an opportunity to learn skills that are not described in papers and software implementations.}
