...
Also, while many industry hackathons are competitive, with teams actively competing to solve the same problems for prizes that are awarded prizes, academic hackathons, and specifically the hack weeks that we have organized events are not explicitely competitive
