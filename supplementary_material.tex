...
\textbf{Question} & \multicolumn{8}{c}{\textbf{Astro Hack Week}} & \multicolumn{8}{c}{\textbf{GeoHackWeek}} & \multicolumn{8}{c}{\textbf{NeuroHackWeek}} \\ \midrule
 & $N$ & $\mathrm{dof}_{\chi^2}^\emph{a}$ & $\chi^2$ & $p$ & $\mathrm{dof}_{\phi_c}^\emph{b}$ & $\phi_c$ & $\mathrm{CI}_{\mathrm{U}}$ & $p_{\mathrm{eq}}$ 
 & $N$ & $\mathrm{dof}_{\chi^2}^\emph{a}$ & $\chi^2$ & $p$ & $\mathrm{dof}_{\phi_c}^\emph{b}$ & $\phi_c$ & $\mathrm{CI}_{\mathrm{U}}$ & $p_{\mathrm{eq}}$ 
 & $N$ & $\mathrm{dof}_{\chi^2}^\emph{a}$ & $\chi^2$ & $p$ & $\mathrm{dof}_{\phi_c}^\emph{b}$ & $\phi_c$ & $\mathrm{CI}_{\mathrm{U}}$ &$p_{\mathrm{eq}}$  \\ \midrule
...
\end{tabularx}
   \begin{tablenotes}
      ...
      \item[\emph{c}]{Responses to the question of career stage were grouped into three categories: early-career stage; faculty and research scientists; other}
