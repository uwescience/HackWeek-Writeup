...
- add a few sentences about size and interaction with goals
- add a few sentences about duration and interaction with goals
- add that we're still figuring this out
- we're experimenting with length and duration


\subsubsection{Participant selection}

Add more on participant selection, especially practical details. 
- add problem of asking good questions: especially questions that require candidates to calibrate should be written in such a way that they allow for objective calibration (e.g. ask for specific actions people have taken, rather than "beginner", "intermediate", "expert"
- add other approaches taken by the three different hack weeks

- add different criteria for selection
...
\subsection{Ensuring Participation}
to add here:
- things about inclusion and how to make people participate
- add sentence about that to main paper
- ANthony needs to add stuff here
- add e.g. that we planted designated question askers
- have organizers as dedicated facilitators
