...
\textbf{Question} & \multicolumn{6}{c}{\textbf{Astro Hack Week}} & \multicolumn{6}{c}{\textbf{GeoHackWeek}} & \multicolumn{6}{c}{\textbf{NeuroHackWeek}} \\ \midrule
 & $N$ & $\mathrm{dof}_{\chi^2}$ & $\chi^2$ & $p$ & $\mathrm{dof}_{\phi_c}$ & $\phi_c$ & $N$ & $\mathrm{dof}_{\chi^2}$ & $\chi^2$ & $p$ & $\mathrm{dof}_{\phi_c}$ & $\phi_c$ & $N$ & $\mathrm{dof}_{\chi^2}$ & $\chi^2$ & $p$ & $\mathrm{dof}_{\phi_c}$ & $\phi_c$ \\ \midrule
...
We caution the reader that the survey results should be read only as an indication of the hypotheses we proposed about the use and outcomes of hack weeks, in line with the exploratory nature of the surveys conducted as part of the hack weeks. The most important independent variable--attendance at the hack week--is something that our current survey design cannot account for. Moreover, self-reported learning outcomes are not an objective measure, because they are likely subject to internal biases of respondents. While these surveys were largely of an exploratory nature, future work will include more a more refined survey design as well as attendance versus non-attendance as a control variable.
