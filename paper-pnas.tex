...
\matmethods{
We performed post-attendance survey for AHW, GHW and NHW in 2016. All three surveys contained general questions about attitudes towards the workshop as well as open science and reproducibility, and their own skills in statistical and computational methods, shared among all three surveys. The NHW and GHW surveys were administered on site on the last day of the workshop; AHW participants were e-mailed immediately after the workshop, with reminders after several weeks. We received full responses from 121 out of 140 participants (AHW: 35, NHW: 44, GHW: 42). The experimental procedures were approved by the Institutional Review Boards at UW, NYU and UC Berkeley. All participants gave their informed consent.
